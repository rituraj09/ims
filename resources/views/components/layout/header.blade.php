...
<header class="topbar">
    ...
    <div class="topbar-right">
        ...
        @can('assets.create')
            <a href="{{ route('admin.assets.create') }}" class="btn btn-primary btn-sm d-none d-sm-inline-flex">
        ...
        {{-- Notifications --}}
        <div class="dropdown">
            <button type="button" class="tb-btn" id="notifDropdown" data-bs-toggle="dropdown"
            ...
            <div class="dropdown-menu dropdown-menu-end notif-dropdown" aria-labelledby="notifDropdown">
                <div class="notif-dd-head">
                    ...
                    @if ($unreadCount > 0)
                        <a href="{{ route('admin.notifications.markAllRead') }}" class="text-primary">Mark all read</a>
                    @endif
                </div>
        ...
        {{-- User Dropdown --}}
        <div class="dropdown">
            <button type="button" class="tb-user-btn" id="userDropdown" data-bs-toggle="dropdown"
                aria-expanded="false">
                <img src="https://ui-avatars.com/api/?name={{ urlencode(auth()->user()->name) }}&background=3b82f6&color=fff&size=56&bold=true"
                    alt="{{ auth()->user()->name }}" class="tb-user-img">
                ...
                <i class="fas fa-chevron-down text-muted d-none d-md-inline" style="font-size:9px;margin-left:2px;"></i>
            </button>

            <ul class="dropdown-menu dropdown-menu-end tb-dropdown" aria-labelledby="userDropdown">
                <li>
