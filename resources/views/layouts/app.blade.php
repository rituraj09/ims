...
<head>
    ...
    <title>@yield('title', 'Dashboard') | {{ setting('general.app_name', 'GovAsset') }}</title>
    @php
        $orgLogo = setting('organisation.org_logo');
    @endphp

    <link rel="icon" type="image/png" href="{{ $orgLogo ? asset('storage/' . $orgLogo) : asset('favicon.ico') }}">
