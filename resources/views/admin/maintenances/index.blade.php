...
<div class="card">
            ...
            <table class="table table-hover mb-0">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            @php
                                $sc = ['scheduled'=>'info','in_progress'=>'warning','completed'=>'success','cancelled'=>'danger'];
                            @endphp
                            <span class="status-pill text-{{ $sc[$maint->status]??'secondary' }}
                        ...
                        <td>
                            <div class="d-flex gap-1">
                                ...
                                <form action="{{ route('admin.maintenances.destroy', $maint) }}"
    ...
    <div class="card-footer">{{ $maintenances->links() }}</div>
    @endif
</div>
@endsection
