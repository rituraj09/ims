                    ...
                    <nav class="nav flex-column gap-1">
                        @php
                            $settingNavs = [
                                ...
                                [
                                    'route' => 'admin.settings.organisation',
                        ...
                        <div class="row g-3">
                            <div class="col-md-6">
                                ...
                                <input type="text" name="app_name" class="form-control"
                                    value="{{ $settings['app_name'] ?? 'GovAsset Manager' }}" required>
                            </div>
                            <div class="col-md-6">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row g-3">
                            <div class="col-md-6">
                                ...
                                <input type="text" name="asset_tag_format" class="form-control"
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="text" name="asset_tag_org_code" class="form-control"
                                    value="{{ $assetTagSettings['org_code'] }}" style="text-transform:uppercase;">
                            </div>
                            <div class="col-md-3">
