...
<div class="card">
    <div class="card-body p-0">
        ...
        <div class="d-flex gap-3 p-3 border-bottom {{ is_null($notif->read_at) ? '' : 'bg-light' }}"
            ...
            <div style="width:40px;height:40px;border-radius:50%;background:var(--primary);display:flex;align-items:center;justify-content:center;color:#fff;flex-shrink:0;font-size:15px;">
