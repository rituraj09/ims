...
@section('content')
    <div class="card">
                    ...
                    <tbody>
                        @forelse($designations as $i => $desig)
                            <tr>
                                ...
                                <td>
                                    <span
                                        class="status-pill text-{{ $desig->status === 'active' ? 'success' : 'danger' }} bg-{{ $desig->status === 'active' ? 'success' : 'danger' }} bg-opacity-10">
                                ...
                                <td>
                                    <div class="d-flex gap-1">
                                        ...
                                        <form action="{{ route('admin.designations.destroy', $desig) }}" method="POST"
                                            class="d-inline">
                                            @csrf @method('DELETE')
        ...
        @if ($designations->hasPages())
            <div class="card-footer">{{ $designations->links('pagination::bootstrap-5') }}</div>
        @endif
    </div>
